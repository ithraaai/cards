...
-- =================================================================
-- ✓ آمن للتنفيذ عدة مرات (IF NOT EXISTS + ON CONFLICT + DELETE-THEN-INSERT)
-- ✓ يمكنك إعادة تنفيذه دون قلق
-- =================================================================
...
-- ملاحظة: يستخدم DELETE-THEN-INSERT للمعايير، وON CONFLICT للقوائم
-- ═══════════════════════════════════════════════════════════════════════
